...
static const yytype_int16 yyrline[] =
{
     ...
     430,   438,   446,   450,   456,   463,   467,   479,   482,   486,
     492
};
#endif
...
#line 1245 "obj/le_parser.c"
    break;

  case 5: /* StructDecls: %empty  */
#line 79 "src/le_parser.y"
      { (yyval.node) = NULL; }
#line 1251 "obj/le_parser.c"
    break;
...
#line 1347 "obj/le_parser.c"
    break;

  case 14: /* DeclVars: %empty  */
#line 151 "src/le_parser.y"
    { (yyval.node) = NULL; }
#line 1353 "obj/le_parser.c"
    break;
...
#line 1495 "obj/le_parser.c"
    break;

  case 28: /* SuiteInstr: %empty  */
#line 262 "src/le_parser.y"
    { (yyval.node) = NULL; }
#line 1501 "obj/le_parser.c"
    break;
...
#line 1627 "obj/le_parser.c"
    break;

  case 39: /* Exp: TB  */
#line 356 "src/le_parser.y"
    { (yyval.node) = (yyvsp[0].node); }
#line 1633 "obj/le_parser.c"
    break;
...
#line 1665 "obj/le_parser.c"
    break;

  case 43: /* FB: M  */
#line 384 "src/le_parser.y"
    { (yyval.node) = (yyvsp[0].node); }
#line 1671 "obj/le_parser.c"
    break;
...
#line 1703 "obj/le_parser.c"
    break;

  case 47: /* E: T  */
#line 412 "src/le_parser.y"
    { (yyval.node) = (yyvsp[0].node); }
#line 1709 "obj/le_parser.c"
    break;
...
#line 1722 "obj/le_parser.c"
    break;

  case 49: /* T: F  */
#line 426 "src/le_parser.y"
    { (yyval.node) = (yyvsp[0].node); }
#line 1728 "obj/le_parser.c"
    break;
...
#line 1760 "obj/le_parser.c"
  ...
  case 53: /* F: NUM  */
#line 451 "src/le_parser.y"
    {
      char buf[32];
      snprintf(buf, sizeof(buf), "%d", (yyvsp[0].num));
      (yyval.node) = makeNode(num, buf);
    }
#line 1770 "obj/le_parser.c"
    break;

  case 54: /* F: CHARACTER  */
#line 457 "src/le_parser.y"
    {
      char buf[2];
...
#line 480 "src/le_parser.y"
    { (yyval.node) = (yyvsp[0].node); }
#line 1808 "obj/le_parser.c"
    break;

  case 58: /* Arguments: %empty  */
#line 482 "src/le_parser.y"
    { (yyval.node) = NULL; }
#line 1814 "obj/le_parser.c"
    break;

  case 59: /* ListExp: ListExp ',' Exp  */
#line 487 "src/le_parser.y"
    {
      Node *tmp = (yyvsp[-2].node) ? (yyvsp[-2].node) : makeNode(ListExp, NULL);
      addChild(tmp, (yyvsp[0].node));
      (yyval.node) = tmp;
    }
#line 1824 "obj/le_parser.c"
    break;
...
#line 1834 "obj/le_parser.c"
    break;


#line 1838 "obj/le_parser.c"
